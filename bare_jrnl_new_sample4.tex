...
\subsubsection{Knowledge-informed intelligent fault diagnosis}
Recently, owing to considerations of both performance and explainability, many knowledge-informed diagnostic methods have emerged \cite{deng_physics-informed_2023}.  By utilizing variational mode decomposition and a dual model of convolutional recurrent neural network, Qin et al. \cite{qin_vwm-dcrnn_2023} proposed a new diagnostic method aimed at identifying faults in insulated gate bipolar transistors. Ha et al. \cite{ha_domain_2023} employed a health data map to visually display the vibration signal of the planetary gearbox in the form of an image-like matrix, facilitating the observation of fault-related characteristics. Su et al. \cite{su_knowledge-informed_2024} introduced a knowledge-informed deep network to utilize knowledge-based features along with data-driven constrained Gaussian process for precise prediction of bearing faults. Ni et al. \cite{ni_physics-informed_2023} introduced a new physics-informed residual network designed to learn the inherent physics present in both training and testing data. This network includes a physical modal-property-dominant-generated layer and a domain-conversion layer, aiming to offer a physically consistent solution for imperfect data.
...
%          TIFN& \textbf{34.37k}& √& 100$\pm$0&\textbf{98.75$\pm$0.02}\\ 
%          M1& 384.64k& /& 100$\pm$0&52.38$\pm$4.17\\ 
%          M2& 384.55k& √& 100$\pm$0&50.34$\pm$23.34\\ \hline
%  M3& 384.55k& √& 100$\pm$0&61.86$\pm$19.38\\
%  M4& 87.00k& √& 100$\pm$0&96.05$\pm$2.77\\  \hline
%     \end{tabular}
% \end{table*}
...
% \begin{figure}[htbp]
% \centerline{\includegraphics[width=0.95\linewidth]{Figs/case1/accuracy_vs_snr_case2.pdf}}
...
Future research will focus on expanding the EKD and conducting more extensive tests with additional data and diagnostic tasks to further enhance the applicability of DSOA and XOAN.  
